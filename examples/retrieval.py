...
model = Model(base_checkpoint="../lightning_logs/full_run/scincl_ctrl/checkpoints/", task_id="[SAL]", use_ctrl_codes=True)
...
evaluator = SupervisedEvaluator("feeds_1", SupervisedTask.CLASSIFICATION, ("allenai/scirepeval", "feeds_1"),
                                ("allenai/scirepeval_test", "feeds_1"), model, metrics=("map", "ndcg",))
